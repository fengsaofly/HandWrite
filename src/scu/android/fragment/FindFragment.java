...
//			map.put("find_icon", getActivity().getResources().getDrawable(R.drawable.home_bottom_onehead));
...
//						map.put("find_upload_img_flag", 1);
//						map.put("find_upload_img", drawableToBitmap((Drawable)data.get(i).get("find_icon")));
...
//					}
//					DownLoadFindBitmaps dfb = new DownLoadFindBitmaps(getActivity(), getActivity(), handler, urls, positions);
//					dfb.execute();
//				}
//				
//				break;
...
//				map.put("find_publish_time", data.get(position).get("find_publish_time"));
...
//				break;
//			case 3:
//				GetContanctsFindsThread gcft = new GetContanctsFindsThread(getActivity(),getActivity(),handler);  //从服务器获取好友动态信息
//				
//				gcft.start();
//				pd.show();
//				break;
