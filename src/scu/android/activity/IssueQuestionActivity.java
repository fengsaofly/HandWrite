...
public class IssueQuestionActivity extends Activity {
	...
	public void init() {
		...
		objWidth = objHeight = (AppUtils.getWindowMetrics(this).widthPixels - 10) / 4;
	...
	private class ThumbnailsAdapter extends BaseAdapter {
		private Context context;
		private ArrayList<String> paths;

		public ThumbnailsAdapter(Context context, ArrayList<String> paths) {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			thumbnail.setImageBitmap(BitmapUtils.getThumbnails(
					IssueQuestionActivity.this, (String) getItem(position),
					objWidth, objHeight));
			android.view.ViewGroup.LayoutParams params = thumbnail
					.getLayoutParams();
			params.width = params.height = objWidth;
