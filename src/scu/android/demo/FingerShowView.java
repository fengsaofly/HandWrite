...
public class FingerShowView extends SurfaceView implements Callback {
	...
	/* view背景颜色 */
	private int bgColor = Color.parseColor("#FFFFCC");
	/* 换行线与view边缘的距离 */
	...
	private int spacesWidth = 20;// 空格的宽度
	private int cursorWidth = 3;// 光标的宽度
	private int linesColor = 0xff000000;// 横线的颜色
	...
	public void initView() {
		...
		cursorHeight = lineHeight - 8;// 光标比行高少8xp
		baseLine = lineHeight;
		// 计算光标闪烁位置
	...
	public String getHandWritePath() {
		Bitmap dst=Bitmap.createBitmap(bitmap, 0, 0,bitmap.getWidth(),yLocation+lineHeight*2);
		return BitmapUtils.saveBitmap(getContext(), dst, AppUtils.HANDWRITE_DIR, null,dst.getWidth(),dst.getHeight());
	}
