...
//				golmt.execute();
	...
	public void myOnclick(View v){
		...
		case R.id.login_popup_view:
			startActivity(new Intent(LoginActivity.this,SelectPicPopupWindow.class));
			break;
		case R.id.screen :
              InputMethodManager imm = (InputMethodManager)this.getSystemService(Context.INPUT_METHOD_SERVICE);  
              userName.setCursorVisible(false);//失去光标
              passWord.setCursorVisible(false);//失去光标
...
//						finish();
	...
	public void initial(){
		...
		login_popup_view = (ImageView)findViewById(R.id.login_popup_view);
