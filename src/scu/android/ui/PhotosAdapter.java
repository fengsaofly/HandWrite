...
public class PhotosAdapter extends BaseAdapter {
	...
	private List<String> bitmaps;// 原图
	...
	public PhotosAdapter(Activity activity, List<String> thumbnails) {
	 ...
	 *            原图路径
	 */
	public PhotosAdapter(Activity activity, List<String> thumbnails, List<String> bitmaps) {
	...
	public void init(Activity activity, List<String> thumbnails) {
		this.activity = activity;
		this.thumbnails = thumbnails;

		this.loader = ImageLoader.getInstance();
		this.options = new DisplayImageOptions.Builder().showImageOnLoading(R.drawable.default_photo).showImageForEmptyUri(R.drawable.default_photo).showImageOnFail(R.drawable.default_photo)
				.cacheInMemory(true).cacheOnDisk(true).considerExifParams(true).bitmapConfig(Bitmap.Config.ARGB_8888).build();
		this.columnNum = 3;
	...
	public void showImage(final String imageDir, final ImageView imageView) {
		...
		final boolean isFromNetwork = (uri.startsWith("http://")) ? true : false;
		if (isFromNetwork) {
